...
export default function Mobilejfs(){
    ...
    return(
      ...
      <div className="image-container">
          <img  className="image" src="https://www.explore-liverpool.com/wp-content/uploads/2022/08/LiverpoolShop-flatlay.jpg" alt="Case Study" />
        </div>
      ...
      <div className="image-container" style={{marginBottom:'100px'}}>
        <img className='image' style={{borderRadius: '20px'}} src="https://firebasestorage.googleapis.com/v0/b/johnsfootballshirts.appspot.com/o/portfoliowebsitepictures%2FJohn'sMobileLandingPage%20(1).png?alt=media&token=b46ed684-18df-4613-9084-3902f3145d78" alt="Case Study" />
      </div>
      {showScrollToTop && (
